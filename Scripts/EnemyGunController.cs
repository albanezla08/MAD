...
public class EnemyGunController : EnemyController
{
    ...
    {
        state_machine.change_state(new ChaseState(rb, chase_speed, change_to_aiming, transform, player_transform, shoot_at_player_range, sprite_renderer, exclamation_renderer));
    }
