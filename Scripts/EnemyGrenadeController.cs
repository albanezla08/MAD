...
public class EnemyGrenadeController : EnemyController
{
    ...
    protected override void change_to_chase() {
        state_machine.change_state(new ChaseState(rb, chase_speed, detonate, transform, player_transform, explode_player_distance, sprite_renderer, exclamation_renderer));
    }
    void detonate() {
